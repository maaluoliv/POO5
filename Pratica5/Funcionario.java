...
public class Funcionario {
    private String nome, departamento, dataEntrada, rg, banco;
    private double salario;
    private boolean statusFun = true;


    public Funcionario(String nome, String departamento, String dataEntrada, String rg, String banco,  double salario) {
        this.nome = nome;
